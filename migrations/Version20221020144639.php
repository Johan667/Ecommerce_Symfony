 ...
 */
final class Version20221020144639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE star CHANGE product_id product_id INT NOT NULL, CHANGE user_id user_id INT NOT NULL, CHANGE note note SMALLINT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE star CHANGE product_id product_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE note note SMALLINT DEFAULT NULL');
    }
}
